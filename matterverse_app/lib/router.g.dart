      ...
      branches: [
        ...
        StatefulShellBranchData.$branch(
          routes: [
            GoRouteData.$route(
              path: '/devices',
              factory: $DevicesPageRouteExtension._fromState,
            ),
          ],
        ),
        StatefulShellBranchData.$branch(
...
extension $DevicesPageRouteExtension on DevicesPageRoute {
  static DevicesPageRoute _fromState(GoRouterState state) =>
